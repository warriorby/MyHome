    ...
    if ($password == $pwd) {
        switch ($login_type) {
            case 2:
                ...
                $rs2_arr = $d2b->select("user_main", ["uname", "phone"], ["uid" => $uid_p]);
                ...
                /*$rs6_arr = $d2b->select("user_im_group", ["group_gid", "group_classid"], ["uid" => $uid_c]);
                $group_gid = $rs6_arr[0]['group_gid'];
                $group_classid = $rs6_arr[0]['group_classid'];*/
            ...
            case 1:
                ...
                $rs2_arr = $d2b->select("user_main", ["uname", "phone"], ["uid" => $uid_c]);
                $uname = $rs2_arr[0]['uname'];
                $phone = $rs2_arr[0]['phone'];
                // $role = $rs2_arr[0]['role'];
                ...
                $return_arr = array('uid_c' => $uid_c,"uid_p"=>$uid_p,'uname' => $uname, 'phone' => $phone, 'role' => $role, 'real_name_c' => $real_name_c,"zid"=>$zid,
